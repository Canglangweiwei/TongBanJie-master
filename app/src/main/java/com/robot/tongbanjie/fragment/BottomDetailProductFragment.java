...
public class BottomDetailProductFragment extends BaseFragment {
    ...
    public void initView() {
        ...
        tabLayoutTitle.addTab(tabLayoutTitle.newTab().setText(listTitle.get(0)));
        tabLayoutTitle.addTab(tabLayoutTitle.newTab().setText(listTitle.get(1)));
        tabLayoutTitle.addTab(tabLayoutTitle.newTab().setText(listTitle.get(2)));
