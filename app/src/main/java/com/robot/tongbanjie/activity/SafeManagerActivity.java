...
public class SafeManagerActivity extends BaseActivity implements OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.safe_manager_modify_login_pwd:        // 修改登录密码
                LoginPasswdModifyActivity.start(this);
                break;
            case R.id.safe_manager_retrieve_pwd:            // 找回交易密码
                FindPasswdActivity.start(this);
                break;
            case R.id.safe_manager_modify_trade_pwd:        // 修改交易密码
                TradePwdModifyActivity.start(this);
                break;
            case R.id.safe_manager_lock_pattern:            // 手势密码
                LockPatternGuideActivity.start(this);
                break;
            case R.id.safe_manager_device_manager:          // 设备管理
