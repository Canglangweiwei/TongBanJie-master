...
public class SafeKeyboardView extends LinearLayout {
    ...
    private void addHeader() {
        LayoutInflater.from(getContext()).inflate(R.layout.view_keyboard_header, this);
    }
    ...
    public class KeyAdapter extends BaseAdapter {
        ...
        static final String KEY_CONFIRM = "确定";
        static final String KEY_DEL = "删除";

        private final String[] numbers = new String[]{"1", "2", "3", "4", "5", "6", "7", "8", "9", "0"};
        private List<String> keyList = new ArrayList<>(Arrays.asList(numbers));
        private Context mContext;

        KeyAdapter(Context context) {
            mContext = context;
            insertSpecialKey();
        }
    ...
    public interface OnAddListener {
        void onAdd(View view, String number);
    }
