...
public class InputPasswordView extends LinearLayout
        implements SafeKeyboardView.OnAddListener,
        SafeKeyboardView.OnDeleteListener,
        SafeKeyboardView.OnConfirmListener {
    ...
    private List<String> mPassword = new ArrayList<>(PASSWORD_CNT);
    private List<ImageView> mImageList = new ArrayList<>(PASSWORD_CNT);
    private OnPasswdEmptyListener mOnPasswdEmptyListener;
    private OnPasswdCompletedListener mOnPasswdCompletedListener;
    private OnPasswdConfirmListener mOnPasswdConfirmListener;
    ...
    public void setOnPasswdConfirmListener(OnPasswdConfirmListener onPasswdConfirmListener) {
        this.mOnPasswdConfirmListener = onPasswdConfirmListener;
    }
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (state instanceof Bundle) {
            ...
            if (passwordArray != null) {
                Collections.addAll(mPassword, passwordArray);
            }
            refreshPasswdView(mPassword);
    ...
    public void onConfirm(View view) {
        mOnPasswdConfirmListener.onConfirm(mPassword);
    }
    ...
    public interface OnPasswdConfirmListener {
        void onConfirm(List<String> pwds);
    }
}